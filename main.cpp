...
//    for(int i = 0; i < nelem; i++) {
//        cout << nnode_elem << " " << ElemNode[i + nelem] << " " << ElemNode[i + nelem * 2] << " " << ElemNode[i + nelem * 3] << " "
...
//    }
    ...
    */
    ...
    ofstream vOut("Case1.vtk", ios::out | ios::trunc);      // output to file, overwrite if already present
